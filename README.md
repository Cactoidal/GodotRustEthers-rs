...
The example in this guide uses a pre-deployed smart contract.  If you are new to smart contracts and want a brief overview of what they are, and some design considerations to keep in mind when creating them, please refer to the section at the end of this guide.
